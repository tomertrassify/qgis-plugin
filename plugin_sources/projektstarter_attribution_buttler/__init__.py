...
def _register_legacy_module_alias():
    if "nextcloud_form_plugin.form_handler" in sys.modules:
        return
...
def classFactory(iface):
    from .plugin import ProjectStarterAttributionButlerPlugin

    return ProjectStarterAttributionButlerPlugin(iface)
