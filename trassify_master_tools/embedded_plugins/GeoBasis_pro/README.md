...
Das Plugin vereinfacht das Finden und Einfügen ausgewählter WMS-, WMTS-, WFS-, XYZ- und VectorTiles-Dienste aus den Open Data Portalen der Landesvermessungsämter und des Bundes sowie von Hintergrundkarten (OSM, Basemap.de, USGS, Google, ...) zum aktuellen View. Ziel ist es, eine deutschlandweite Sammlung der GeoBasisdaten mit aktuellen Links anzubieten. Mehr Informationen zum GeoBasis_Loader inkl. Status, Versionshistorie und FAQs auf <a href="https://geoobserver.de/qgis-plugin-geobasis-loader/">geoObserver.de</a>
...
The plugin makes it easier to find and insert selected WMS-, WMTS-, WFS-, XYZ- und VectorTiles services from the open data portals of the state surveying offices and background maps (OSM, Basemap.de, USGS, Google, ...) for the current view. The aim is to provide a Germany-wide collection of geodata with up-to-date links. More information about GeoBasis_Loader incl. status, version history and FAQs on <a href="https://geoobserver.de/qgis-plugin-geobasis-loader/">geoObserver.de</a>
